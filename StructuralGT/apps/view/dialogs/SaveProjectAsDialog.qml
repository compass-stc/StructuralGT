...
Dialog {
    ...
    Column {
        ...
        Text {
            text: "Save current project to a new .sgtproj file"
            font.pixelSize: 14
        ...
        Text {
            text: "This will save all networks, settings, and analysis results to a new project file."
            font.pixelSize: 12
            color: "gray"
            wrapMode: Text.WordWrap
            width: parent.width
