...
def save_data_3d(src, Thresh_method, gamma, md_filter, g_blur, autolvl, fg_color, asize, bsize, wsize, thresh, laplacian, \
    ...
    # Currently, only change is that src is stack of tiffs, not a single image
    ...
    img, img_bin, ret = process_image.binarize(i, Thresh_method, gamma, md_filter, g_blur, autolvl, fg_color, \
